...
(function(root, factory) {
  ...
  "use strict";
  var NAMESPACE = "animation.velocity"; // (BUILD) - REMOVE IN MINIFY - START
  ...
  ScrollMagic.Scene.extend(function() {
    var Scene = this,
      ...
      _properties,
      _options,
      _dataID; // used to identify element data related to this scene, will be defined everytime a new velocity animation is added // (BUILD) - REMOVE IN MINIFY - START
    var log = function() {
      if (Scene._log) {
    ...
    }; // (BUILD) - REMOVE IN MINIFY - END // set listeners
        ...
        if (progress != _currentProgress) {
          ...
          if (Scene.duration() === 0) {
            ...
            if (progress > 0) {
              ...
              // play reverse
              reverse(_elems, _options); // velocity(_elems, _propertiesReverse, _options); // velocity("reverse");
            }
          } else {
    ...
    Scene.setVelocity = function(elems, properties, options) {
      ...
      checkDuration(); // (BUILD) - REMOVE IN MINIFY - END
